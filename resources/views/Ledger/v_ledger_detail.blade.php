            ...
            @foreach($result as $row)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <button type="button" class="btn btn-danger text-dark d" data-toggle="modal" data-target="#delete" >
                            <a class="nav-link d-flex align-items-center py-0" style="color:#6D6D6D;">
