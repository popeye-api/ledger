...
<div class="container-fluid">
    ...
    <button  type="button" style="background-color:#FF7A33;" class="btn btn-primary bd-add-modal-lg" ><a href="{{url('v_ledger_add')}}" class="nav-link d-flex align-items-center py-0 text-white">Add list</a></button>
